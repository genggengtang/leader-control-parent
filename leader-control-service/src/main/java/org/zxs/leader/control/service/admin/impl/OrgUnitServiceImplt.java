...
import org.zxs.leader.control.service.admin.interf.OrgUnitService;
import org.zxs.leader.control.service.util.ExceptionMessageTranslator;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;

public class OrgUnitServiceImplt implements OrgUnitService {
	
	@Resource
	private IOrgUnitMapper orgUnitMapper;
	
	private static final Log logger = LogFactory.getLog(OrgUnitServiceImplt.class);
